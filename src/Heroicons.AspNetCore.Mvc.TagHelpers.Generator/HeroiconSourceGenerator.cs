    ...
    public class HeroiconSourceGenerator : IIncrementalGenerator
    {
        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            var namesProvider = iconsProvider.Select(static (icons, _) =>
                icons.Select(static x => x.Name).Distinct().OrderBy(x => x, StringComparer.OrdinalIgnoreCase).ToImmutableList());
        ...
        internal static void GenerateHeroiconKindType(StringBuilder sb, IReadOnlyList<string> kinds, CancellationToken ct) =>
        ...
        internal static void GenerateHeroiconNameType(StringBuilder sb, IReadOnlyList<string> names, CancellationToken ct) =>
            sb.AppendNamespace(0, NamespacePublic, (sb2, indent2) =>
            {
        ...
        internal static void GenerateSingleTagBuilderFactory(StringBuilder sb, Icon icon, CancellationToken ct) =>
        ...
        public static void GenerateHeroiconTagBuilderFactoryType(StringBuilder sb, IReadOnlyList<string> kinds, IReadOnlyList<string> names, CancellationToken ct) =>
